...
@section('content')
    <div class="bg-white p-5 rounded-lg shadow-md">
        ...
        <div class="flex justify-between items-center mb-5">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('employee.create') }}" class="bg-green-600 text-white px-3 py-1.5 rounded-lg hover:bg-green-700 transition duration-200 text-sm flex items-center">
