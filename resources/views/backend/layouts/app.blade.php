    ...
    <header class="bg-blue-900 text-white py-3 shadow-md">
        <div class="container mx-auto flex items-center px-6">
            ...
            <nav class="flex-1 flex justify-center space-x-6 -ml-55">
                ...
                <a href="{{ route('employee.index') }}" class="{{ request()->is('employee') ? 'bg-white text-blue-900 rounded-lg' : '' }} px-4 py-1 hover:bg-white hover:text-blue-900 hover:rounded-lg">Employee</a>
                <a href="{{ route('lokasi.index') }}" class="{{ request()->is('lokasi') ? 'bg-white text-blue-900 rounded-lg' : '' }} px-4 py-1 hover:bg-white hover:text-blue-900 hover:rounded-lg">Lokasi</a>
            </nav>
        </div>
    </header>
